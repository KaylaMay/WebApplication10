...
(function (DlhSoft) {
    ...
    (function (Controls) {
            ...
            var Element = (function () {
                ...
                Element.initializeSettings = function (settings) {
                    ...
                    if (typeof settings.headerProvider === "undefined")
                        settings.headerProvider = function (document, value) { return document.createTextNode(value != null ? value.toString() + " - " + (value + settings.rows * settings.columns - 1).toString() : "?"); };
                    ...
                    if (typeof settings.timeFormatter === "undefined")
                        settings.timeFormatter = function (value) { return value.toString(); };
                ...
                Element.prototype.refresh = function () {
                    ...
                    previousButtonLink.onclick = function (e) { _this.setDisplayedValue(displayedTime - (_this.settings.rows * _this.settings.columns)); e.stopPropagation(); };
                    ...
                    nextButtonLink.onclick = function (e) { _this.setDisplayedValue(displayedTime + (_this.settings.rows * _this.settings.columns)); e.stopPropagation(); };
        ...
        })(CalendarSelector = Controls.CalendarSelector || (Controls.CalendarSelector = {}));
        var Calendar;
        (function (Calendar) {
                        ...
                        for (var c = 0; c < this.settings.monthColumns; c++) {
                            ...
                            if (this.settings.calendarSelectorLevels < 1 || r > 0 || c > 0) {
                                ...
                                monthLink.onclick = function (e) {
                                    ...
                                    var monthSelectorSettings = {
                                        ...
                                        headerProvider: function (document, time) {
                                            ...
                                            yearLink.onclick = function (e) {
                                                    ...
                                                    headerProvider: function (document, time) {
                                                        ...
                                                        decadeLink.onclick = function (e) {
                                                            ...
                                                            var decadeSelectorSettings = {
                                                                ...
                                                                // theme: "Standard",
                                                                rows: 5, columns: 2, invertMatrix: true,
                                                                headerProvider: function (document, time) { return document.createTextNode((time * 10 + 1).toString() + " - " + ((time + 10) * 10).toString()); },
                                                                timeFormatter: function (time) { return (time * 10 + 1).toString() + "-" + (time * 10 + 10).toString().substr((time * 10 + 10).toString().length - 2); },
                                                                minValue: 10
                                                            };
                                                            ...
                                                            decadeSelector.settings.selectedTimeChangeHandler = function (selectedTime) { yearSelector.setDisplayedValue(selectedTime * 10); };
                                                            e.stopPropagation();
                                                        };
                                                        return decadeLink;
                                                    },
                                                    timeFormatter: function (time) { return (time + 1).toString(); },
                                                    minValue: 100
                                                };
                                                ...
                                                yearSelector.settings.selectedTimeChangeHandler = function (selectedTime) { monthSelector.setDisplayedValue((selectedTime + 1) * 12); };
                                                e.stopPropagation();
                                            };
                                            return yearLink;
                                        },
                                        timeFormatter: function (time) { return _this.settings.months[time - Math.floor(time / 12) * 12]; },
                                        minValue: (100 + 1) * 12
                                    };
                                    ...
                                    monthSelector.settings.selectedTimeChangeHandler = function (selectedTime) { _this.setDisplayedValue(new Date(Math.floor(selectedTime / 12), selectedTime - Math.floor(selectedTime / 12) * 12, 1)); };
                                    e.stopPropagation();
                                };
                            }
        ...
        })(Calendar = Controls.Calendar || (Controls.Calendar = {}));
        var DatePicker;
        (function (DatePicker) {
...
//# sourceMappingURL=DlhSoft.Data.DatePicker.HTML.Controls.js.map